...
public class AgregarMateriaCursadaUseCase extends UseCase<RequestCommand<AgregarMateriaCursada>, ResponseEvents> {
    @Override
    public void executeUseCase(RequestCommand<AgregarMateriaCursada> requestCommand){
